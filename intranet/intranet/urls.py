...
from permisos.views import sgc,permisos,agregar_permisos,aprobar_permisos,rechazar_permisos,salida_permisos,entrada_permisos,contenidojson,calidad,eliminar_permiso,permisos_encargado
